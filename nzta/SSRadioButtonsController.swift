...
//  nzta
//
//  Created by Ramesh Kolamala on 11/06/16.
...
class SSRadioButtonsController : NSObject
{
    ...
    init(buttons: UIButton...) {
        ...
        for aButton in buttons {
            aButton.addTarget(self, action: #selector(SSRadioButtonsController.pressed), forControlEvents: UIControlEvents.TouchUpInside)
        }
    ...
    func removeButton(aButton: UIButton) {
        ...
        if(iteratingButton != nil) {
            ...
            iteratingButton!.removeTarget(self, action: #selector(SSRadioButtonsController.pressed), forControlEvents: UIControlEvents.TouchUpInside)
